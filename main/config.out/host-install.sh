...
KMUXINST_VSERVER_NAME="host"
KMUXINST_VSERVER_PATH="var/lib/lxc"
KMUXINST_VSERVER_CHROOT_PATH="$/var/lib/lxc/vserver/rootfs"
KMUXINST_VSERVER_ETC="/stage"

KMUXINST_VSERVER_NR="1"
KMUXINST_VSERVER_CONTEXT="101"

KMUXINST_VSERVER_PACKAGES="syslog-ng ssmtp cron-apt libnss-ldap libpam-ldap ldap-utils"

KMUXINST_VSERVER_DEBIAN_REPDIST_TMP=sarge

msg ${MSG_INFO} "Installing host VServer ..."

export KMUX_HANDLE_DAEMONS=$
...
# Mount proc
mount -t proc proc "/proc" || msg ${MSG_ERR} "Unable to mount ${KMUXINST_VSERVER_CHROOT_PATH}/proc"
# Mount dev
...
msg ${MSG_OK} "Successfully installed host VServer."
